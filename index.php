        ...
        <div class="row">
          <div class="col-12">
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand" href="index.html">  <img src="images/logo2.png" width="250" alt=""></a>
            ...
            <div class="navbar-collapse collapse" id="menu">
              <div class="col-sm-10">
                <ul class="navbar-nav justify-content-center">
                  <li class="nav-item">
                    <a class="nav-link active" href="index.html"><img src="images/iconoGuiaCirculo.png" width="40" alt="">&nbsp;&nbsp;Crear guía</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="col-sm-2">
                  ...
                  <li class="nav-item">
                    ...
                    <a class="nav-link" href="#"   data-toggle="modal" data-target="#acceder"> <img src="images/iconoLogin.png" width="35" alt="">&nbsp;&nbsp;&nbsp;Login</a>
                  </li>
    ...
    <div class="modal-content">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="acceso">
          <form class="form" id="formularioAcceso" action="validarAcceso"
